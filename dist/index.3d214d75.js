...
})({"6m9XZ":[function(require,module,exports) {
...
var _bookJs = require("./modules/book.js");
var _bookJsDefault = parcelHelpers.interopDefault(_bookJs);
// eslint-disable-next-line import/extensions
var _bookManagerJs = require("./modules/bookManager.js");
var _bookManagerJsDefault = parcelHelpers.interopDefault(_bookManagerJs);
// eslint-disable-next-line import/extensions
var _displayBooksJs = require("./modules/displayBooks.js");
var _displayBooksJsDefault = parcelHelpers.interopDefault(_displayBooksJs);
// eslint-disable-next-line import/extensions
var _luxonJs = require("./modules/luxon.js");
const time = document.getElementById("date");
time.innerHTML = (0, _luxonJs.DateTime).now();
const bookForm = document.getElementById("bookForm");
const booksList = document.getElementById("booksList");
const bookManager = new (0, _bookManagerJsDefault.default)();
bookForm.addEventListener("submit", (event)=>{
    ...
    const book = new (0, _bookJsDefault.default)(title, author);
    bookManager.addBook(book);
    titleInput.value = "";
    authorInput.value = "";
    (0, _displayBooksJsDefault.default)(bookManager, booksList);
    bookForm.reset();
});
(0, _displayBooksJsDefault.default)(bookManager, booksList);
...
},{"./modules/book.js":"5AaGw","./modules/bookManager.js":"gbxru","./modules/displayBooks.js":"lCtGD","./modules/luxon.js":"gpC00","@parcel/transformer-js/src/esmodule-helpers.js":"9bNT4"}],"lCtGD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function displayBooks(bookManager, booksList) {
...
exports.default = displayBooks;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"9bNT4"}],"gpC00":[function(require,module,exports) {
/* eslint-disable */ // these aren't really private, but nor are they really useful to document
/**
 * @private
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "DateTime", ()=>DateTime) //# sourceMappingURL=luxon.js.map
;
...
parcelHelpers.export(exports, "SystemZone", ()=>SystemZone);
   ...
   */ shiftTo(...units) {
        ...
        for (const k of orderedUnits$1){
            if (units.indexOf(k) >= 0) {
                ...
                for(const down in vals)if (orderedUnits$1.indexOf(down) > orderedUnits$1.indexOf(k)) convert(this.matrix, vals, down, built, k);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"9bNT4"}]},["6m9XZ","bB7Pu"], "bB7Pu", "parcelRequire46a2")
